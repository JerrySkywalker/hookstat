...
pub const fn text(key: MessageKey) -> &'static str {
    match key {
        ...
        MessageKey::FieldRuntimeContext => "Runtime context",
        ...
        MessageKey::EventInterrupt => "Interrupt",
        MessageKey::EventDescriptionPreToolUse => "Before a tool executes",
        MessageKey::EventDescriptionPermissionRequest => "When permission is requested",
        MessageKey::EventDescriptionPostToolUse => "After a tool executes",
        MessageKey::EventDescriptionPreCompact => "Before context compaction",
        MessageKey::EventDescriptionPostCompact => "After context compaction",
        MessageKey::EventDescriptionSessionStart => "When a new session starts",
        MessageKey::EventDescriptionSessionEnd => "Right before a session ends",
        MessageKey::EventDescriptionUserPromptSubmit => "When the user submits a prompt",
        MessageKey::EventDescriptionSubagentStart => "When a subagent is created",
        MessageKey::EventDescriptionSubagentStop => "Right before a subagent ends its turn",
        MessageKey::EventDescriptionStop => "Right before Codex ends its turn",
        MessageKey::EventDescriptionInterrupt => "Right before an interrupted turn is aborted",
