...
pub const fn text(key: MessageKey) -> &'static str {
    match key {
        ...
        MessageKey::FieldRuntimeContext => "运行时上下文",
        ...
        MessageKey::EventInterrupt => "中断",
        MessageKey::EventDescriptionPreToolUse => "工具执行前",
        MessageKey::EventDescriptionPermissionRequest => "请求权限时",
        MessageKey::EventDescriptionPostToolUse => "工具执行后",
        MessageKey::EventDescriptionPreCompact => "上下文压缩前",
        MessageKey::EventDescriptionPostCompact => "上下文压缩后",
        MessageKey::EventDescriptionSessionStart => "新会话开始时",
        MessageKey::EventDescriptionSessionEnd => "会话结束前",
        MessageKey::EventDescriptionUserPromptSubmit => "用户提交提示时",
        MessageKey::EventDescriptionSubagentStart => "创建子代理时",
        MessageKey::EventDescriptionSubagentStop => "子代理结束当前轮次前",
        MessageKey::EventDescriptionStop => "Codex 结束当前轮次前",
        MessageKey::EventDescriptionInterrupt => "中断的轮次终止前",
