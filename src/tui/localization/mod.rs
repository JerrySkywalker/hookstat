...
pub enum MessageKey {
    ...
    SectionRuntimeConfiguration,
    SectionReliabilitySummary,
    SectionObservationHistory,
    SectionRuntimeIssues,
    SectionHookManagement,
    StateHookManagementUnavailable,
    FieldRuntime,
    FieldCoverage,
    FieldTotalRuns,
    FieldRunCount,
    ...
    StateEmptySearch,
    StateRefreshFailed,
    StateRuntimeCatalogLoading,
    StateRuntimeCatalogStale,
    StateRuntimeCatalogUnavailable,
    StateReliabilityUnavailable,
    StateNotObserved,
    StateJoinAmbiguous,
    ...
    StateAliasSaved,
    StateAliasConflict,
    StateAliasSaveFailed,
    StateObservedInSelectedPeriod,
    StatusHealthy,
    StatusDegraded,
...
pub const ALL_MESSAGE_KEYS: &[MessageKey] = &[
    ...
    MessageKey::NavHooks,
    MessageKey::NavChanges,
    MessageKey::NavDiagnostics,
    MessageKey::NavSettings,
    MessageKey::ViewOverview,
    MessageKey::ViewHooks,
    MessageKey::ViewChanges,
    MessageKey::ViewChangeDetail,
    MessageKey::ViewHookDetail,
    MessageKey::ViewFailureClusters,
    MessageKey::ViewFailureClusterDetail,
    ...
    MessageKey::SectionRuntimeIssues,
    MessageKey::SectionHookManagement,
    ...
    MessageKey::FieldAlias,
    MessageKey::FieldAffectedHooks,
    ...
    MessageKey::FieldInstalled,
    MessageKey::FieldActive,
    MessageKey::FieldReview,
    MessageKey::FieldDescription,
    MessageKey::FieldEnabled,
    MessageKey::FieldDisabled,
    MessageKey::FieldManaged,
    MessageKey::FieldMatcher,
    MessageKey::FieldSource,
    MessageKey::FieldHandlerType,
    MessageKey::FieldCommand,
    MessageKey::FieldMcpServer,
    MessageKey::FieldMcpTool,
    ...
    MessageKey::ValueAsync,
    MessageKey::ValueTrusted,
    MessageKey::ValueUntrusted,
    MessageKey::ValueModified,
    MessageKey::RuntimeIssueWarning,
    MessageKey::RuntimeIssueError,
    MessageKey::HintFocusEvents,
    MessageKey::HintOpenHandlers,
    ...
    MessageKey::ColumnInstalled,
    MessageKey::ColumnActive,
    MessageKey::ColumnReview,
    MessageKey::ColumnHealth,
    MessageKey::ColumnDescription,
    ...
    MessageKey::StateReliabilityUnavailable,
    MessageKey::StateNotObserved,
    MessageKey::StateJoinAmbiguous,
    ...
    MessageKey::StateAliasClean,
    MessageKey::StateAliasDirty,
    MessageKey::StateAliasSaved,
    MessageKey::StateAliasConflict,
    MessageKey::StateAliasSaveFailed,
    MessageKey::StateObservedInSelectedPeriod,
    ...
    MessageKey::ChangeRegression,
    MessageKey::ChangeRecovery,
    MessageKey::ChangeRevision,
    MessageKey::ChangeNewHook,
